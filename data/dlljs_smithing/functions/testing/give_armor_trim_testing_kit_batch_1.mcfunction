...
# 1x Vex Armor Trim Smithing Template
# 1x Wild Armor Trim Smithing Template
# 1x Coast Armor Trim Smithing Template
# 1x Dune Armor Trim Smithing Template
...
give @s minecraft:sentry_armor_trim_smithing_template 1
give @s minecraft:vex_armor_trim_smithing_template 1
